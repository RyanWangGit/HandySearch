...
inline std::string& LTrim(std::string &s) {
  s.erase(s.begin(), std::find_if(s.begin(), s.end(), [](unsigned c) {return !IsSpace(c);}));
  return s;
}

inline std::string& RTrim(std::string &s) {
  s.erase(std::find_if(s.rbegin(), s.rend(), [](unsigned c) {return !IsSpace(c);}).base(), s.end());
  return s;
}
...
inline std::string& LTrim(std::string & s, char x) {
  s.erase(s.begin(), std::find_if(s.begin(), s.end(), [x](unsigned c) {return c != x;}));
  return s;
}

inline std::string& RTrim(std::string & s, char x) {
  s.erase(std::find_if(s.rbegin(), s.rend(), [x](unsigned c) {return c != x;}).base(), s.end());
  return s;
}
